...
int runWhetstone(int loops)
{
 ...
 LCONT:
  ...
  /*
C
CThe actual benchmark starts here.
C
  */
  T  = .499975;
  T1 = 0.50025;
  ...
  /*
C
CWith loopcount LOOP=10, one million Whetstone instructions
Cwill be executed in EACH MAJOR LOOP..A MAJOR LOOP IS EXECUTED
...
C
  */
  ...
  /*
C
CModule 7: Trigonometric functions
C
  */
  X = 0.5;
  Y = 0.5;
